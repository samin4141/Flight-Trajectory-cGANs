...
import pandas as pd
import os
from conv_generator_dicriminator import Generator, Discriminator
from funcs import delta_maker_torch, rev_delta_maker, plot_figures
...
generator = Generator(dim, length)
discriminator = Discriminator(dim, length, device)
